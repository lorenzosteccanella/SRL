...
config= {
    "seed": seed,
    "path_trajectory": dirpath + "/Data/trajectory_Reach.npy",
    "in_d": 10,
    "out_d": 8,
    "in_dist_d": 8,
    "out_dist_d": 8,
    ...
    "wandb_group": "Reach_WN",

    "model_path": dirpath + "/Saved_models/Reach_WN_" + str(seed)
}
...
trajectories = collect_continuous_action_trajectories(env, 200, None)
...
#
#     print({"loss_o": loss_o, "loss_c": loss_c, "loss": loss})
#
