...
model = GCSL_NN(max_n_steps_episode=max_n_steps_episode, input_size=6, actions=actions)
...
wandb_group = "Pendulum_GCSL" + "_wo_h" + "_0.1d"
wandb_name = "Pendulum_GCSL_seed_" + str(seed) + "_wo_h" + "_0.1d"
