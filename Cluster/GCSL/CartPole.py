...
model = GCSL_NN(max_n_steps_episode=max_n_steps_episode, input_size= 9, actions=list(range(env.action_space.n)))
...
wandb_group = "CartPole_GCSL"
wandb_name = "CartPole_GCSL_seed_" + str(seed)
