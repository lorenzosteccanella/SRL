...
model = GCSL_NN(max_n_steps_episode=max_n_steps_episode, input_size=13, actions=list(range(env.action_space.n)))
...
wandb_group = "Acrobot_GCSL"
wandb_name = "Acrobot_GCSL_seed_" + str(seed)
