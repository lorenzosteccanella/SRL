...
model = GCSL_NN(max_n_steps_episode=max_n_steps_episode, input_size= 7, actions=action_space)
...
wandb_group = "FetchReach_GCSL"
wandb_name = "FetchReach_GCSL_seed_" + str(seed)
...
while steps < 100000:
    ...
    wandb.log({"dist_goal": np.linalg.norm(s - desired_goal, 2),
               "n_steps": ep_steps},
              step=steps)
