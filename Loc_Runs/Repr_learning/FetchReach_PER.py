...
from Repr_learning.FetchReach_PER import training_model
...
config = {
    ...
    "ub_w_dist": 1,
    "path_dataset": dirname + "/Data/dataset_FetchReach_disc_2.pt",
    "path_trajectory": dirname + "/Data/trajectory_FetchReach_disc_2.npy",
    ...
    "path_model": dirname + "/Models/FetchReach_action_states_dictionary_disc_2",
    "constr_weight": 1,
    "l_rate": 0.0005,
    "amsgrad": True
