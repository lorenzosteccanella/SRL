...
config = {
    ...
    "ub_w_dist": 1,
    "path_dataset": dirname + "/Data/dataset_CartPole.pt",
    "path_trajectory": dirname + "/Data/trajectory_CartPole.npy",

    # wandb params
    "wandb_record": False,
    "wandb_group": "CartPole",
    ...
    "path_model": dirname + "/Models/CartPole_action_states_dictionary",
    "constr_weight": 0.1,
    "l_rate": 0.001,
    "amsgrad": True
...
def training_model(config):
    ...
    if config["load_trajectories"]:
        ...
        trajectories, states = dqn_cart_pole_collect_trajectories(env,
    ...
    per = PER(trajectories, replay_size=1e9, len_window_o=config["len_window_o"], c_window_len=config["c_window_len"],
